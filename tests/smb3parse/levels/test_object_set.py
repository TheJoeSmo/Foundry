...
from foundry.smb3parse.objects import MIN_DOMAIN, MAX_DOMAIN, MIN_ID_VALUE, MAX_ID_VALUE
from foundry.smb3parse.objects.object_set import ObjectSet, ENEMY_ITEM_OBJECT_SET, MIN_OBJECT_SET, MAX_OBJECT_SET
