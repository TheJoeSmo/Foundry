...
from foundry.core.namespace import Namespace, primitive_manager


@fixture
def empty_namespace():
    return Namespace(None, {}, {}, {}, validators=primitive_manager)


@fixture
def namespace_with_parent(empty_namespace):
    return Namespace(empty_namespace, {}, {}, {}, validators=primitive_manager)


@fixture
def namespace_with_dependency(empty_namespace):
    return Namespace(None, {"a": empty_namespace}, {}, {}, validators=primitive_manager)


@fixture
def namespace_with_parent_with_dependency(empty_namespace):
    return Namespace(empty_namespace, {"a": empty_namespace}, {}, {}, validators=primitive_manager)


@fixture
def namespace_with_dependencies(empty_namespace):
    return Namespace(None, {"a": empty_namespace, "b": empty_namespace}, {}, {}, validators=primitive_manager)


@fixture
def namespace_with_parent_with_dependencies(empty_namespace):
    return Namespace(
        empty_namespace, {"a": empty_namespace, "b": empty_namespace}, {}, {}, validators=primitive_manager
    )


@fixture
def namespace_with_dependency_with_child(empty_namespace):
    return Namespace(None, {"a": empty_namespace}, {}, {"a": empty_namespace}, validators=primitive_manager)


@fixture
def namespace_with_parent_with_dependency_with_child(empty_namespace):
    return Namespace(empty_namespace, {"a": empty_namespace}, {}, {"a": empty_namespace}, validators=primitive_manager)


@fixture
def namespace_with_dependencies_with_child(empty_namespace):
    return Namespace(
        None, {"a": empty_namespace, "b": empty_namespace}, {}, {"a": empty_namespace}, validators=primitive_manager
    )
...
def namespace_with_dependency_with_children(empty_namespace):
    return Namespace(
        None, {"a": empty_namespace}, {}, {"a": empty_namespace, "b": empty_namespace}, validators=primitive_manager
    )
...
def namespace_with_dependency_with_child_with_element(empty_namespace):
    return Namespace(None, {"a": empty_namespace}, {"c": 1}, {"a": empty_namespace}, validators=primitive_manager)


@fixture
def namespace_with_parent_with_dependency_with_child_with_element(empty_namespace):
    return Namespace(
        empty_namespace, {"a": empty_namespace}, {"c": 1}, {"a": empty_namespace}, validators=primitive_manager
    )
...
def namespace_with_dependency_with_child_with_elements(empty_namespace):
    return Namespace(
        None, {"a": empty_namespace}, {"c": 1, "d": 2}, {"a": empty_namespace}, validators=primitive_manager
    )
...
def namespace_with_parent_with_dependency_with_child_with_elements(empty_namespace):
    return Namespace(
        empty_namespace, {"a": empty_namespace}, {"c": 1, "d": 2}, {"a": empty_namespace}, validators=primitive_manager
    )
