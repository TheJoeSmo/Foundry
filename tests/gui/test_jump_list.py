...
def test_add_jump(main_window):
    ...
    jumps_before = len(main_window.level_ref.level.jumps)
    ...
    jumps_after = len(main_window.level_ref.level.jumps)
...
def test_edit_jump(main_window):
    ...
    jump_after = main_window.level_ref.level.jumps[_jump_index]
