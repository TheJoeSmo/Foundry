...
def test_add_jump(main_window):
    ...
    jumps_before = len(main_window.manager.controller.level_ref.level.jumps)
    ...
    jumps_after = len(main_window.manager.controller.level_ref.level.jumps)
...
def test_edit_jump(main_window):
    ...
    main_window.manager.controller.on_jump_edited(updated_jump)
    ...
    jump_after = main_window.manager.controller.level_ref.level.jumps[_jump_index]
