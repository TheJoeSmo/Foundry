...
def get_graphics_pages_from_tileset(tileset: int) -> tuple[GraphicsPage, ...]:
    ...
    graphic_page_index_1 = ROM.as_default()[slice(Level_BG_Pages1, Level_BG_Pages1 + BG_PAGE_COUNT)]
    graphic_page_index_2 = ROM.as_default()[slice(Level_BG_Pages2, Level_BG_Pages2 + BG_PAGE_COUNT)]
    pages = [
